...
## ПРОЦЕСС ВЫПОЛНЕНИЯ
Выполненные этапы проекта сделаны на основе ноутбук-шаблона, результат можно посмотреть в <a href="https://github.com/apyatalov/DS_PROJECT_1/blob/main/headHunter.ipynb">headHunter.ipynb</a> 
